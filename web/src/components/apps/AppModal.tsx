    ...
    <CustomModal isOpen={isOpen} onClose={onClose}>
      <ModalHeader>
        ...
        <div className="flex sm:hidden items-center justify-between gap-3 mt-1 w-full">
          {applicationMeta.category && (
            <span
              className="font-semibold rounded-full text-xs px-2 py-1 bg-zinc-200 text-foreground-700 dark:text-zinc-300 dark:bg-zinc-700 whitespace-nowrap shrink-0"
              title="Category"
            >
              {applicationMeta.category}
            </span>
                    ...
                    <div className="flex items-center justify-between gap-3 w-full">
                      ...
                      <div className="flex-1 min-w-0 flex flex-col justify-center">
                        <div className="flex items-center gap-2 flex-wrap min-w-0">
                          ...
                          {displayPackage &&
                            isNew(
                              group.bundleMeta.appFirstSeen?.[displayPackage],
                            ) && <Badge variant="new" />}
                          {group.bundleMeta.isPreRelease && (
                            <Badge variant="prerelease" />
                          )}
                          {group.bundleMeta.stars > 0 && (
                            <Badge
                              variant="stars"
                              value={group.bundleMeta.stars}
                            />
                          )}
                        </div>
