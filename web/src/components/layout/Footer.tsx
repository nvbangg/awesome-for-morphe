      ...
      <footer className="mt-6 border-t border-divider bg-background pt-5 pb-6">
        <div className="container mx-auto px-6 max-w-300 flex flex-col gap-3">
          <a href="https://awesome-morphe.vercel.app/" className="flex items-center gap-3 no-underline group w-fit">
            ...
            <span className="font-bold text-xl text-foreground group-hover:text-primary transition-colors">Awesome Morphe</span>
          </a>
          <p className="text-foreground-600 dark:text-foreground-500 text-sm">Explore all patch bundles created by the Morphe community.</p>
          <div className="border-t border-divider pt-3 text-foreground-600 dark:text-foreground-500 text-xs leading-relaxed flex flex-col gap-1.5">
            <p>
              <a href="https://github.com/nvbangg/awesome-morphe" target="_blank" rel="noopener noreferrer" className="font-semibold text-primary no-underline hover:opacity-80 transition-opacity">
                This project
              </a>{" "}
            ...
            <p>Only use patch sources or projects you trust. This project is for informational purposes only and is not responsible for any arising issues.</p>
          </div>
        </div>
      </footer>
